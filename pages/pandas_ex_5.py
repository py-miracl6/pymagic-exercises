...
hide_part_of_page()
st.subheader("HW11. Блок Pandas. Задача 5")
...
group_check_2 = (
    df.groupby(["Department", "EducationField", "Attrition"])
...
if content:
    ...
    try:
        ...
        try:
            ...
            assert group_check.equals(loc["median_group"]) or group_check_2.equals(
                loc["median_group"]
